        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="reveal delay-2 relative hidden h-[560px] lg:block">
            <div className="absolute right-0 top-0 h-[340px] w-[260px] overflow-hidden rounded-2xl border border-slate-200 shadow-2xl animate-float">
              <img src="https://images.pexels.com/photos/18635120/pexels-photo-18635120.jpeg?auto=compress&cs=tinysrgb&h=900&w=700" alt="Starry Night Palm Trees" className="h-full w-full object-cover image-zoom" loading="eager" />
            </div>
            <div className="absolute left-0 top-20 h-[300px] w-[230px] overflow-hidden rounded-2xl border border-slate-200 shadow-2xl animate-float" style={{ animationDelay: '1.5s' }}>
              <img src="https://images.pexels.com/photos/19892296/pexels-photo-19892296.jpeg?auto=compress&cs=tinysrgb&h=900&w=700" alt="Gold Leaf Calligraphy" className="h-full w-full object-cover image-zoom" loading="eager" />
            </div>
            <div className="absolute bottom-0 right-12 h-[260px] w-[200px] overflow-hidden rounded-2xl border border-slate-200 shadow-2xl animate-float" style={{ animationDelay: '3s' }}>
              <img src="https://images.pexels.com/photos/11673768/pexels-photo-11673768.jpeg?auto=compress&cs=tinysrgb&h=900&w=700" alt="Sufi Art" className="h-full w-full object-cover image-zoom" loading="eager" />
            </div>
