        ...
        <section className="relative flex min-h-screen items-center overflow-hidden pt-24">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    <div>
                        <div className="reveal mb-5 inline-flex items-center gap-2 rounded-full border border-violet-600/20 bg-violet-50 px-4 py-1.5 text-xs font-medium text-violet-700 shadow-xs">
                            <Sparkles className="h-3.5 w-3.5 text-violet-600" />
                            Handcrafted Original Art since 2020
                        </div>

                        <h1 className="reveal delay-1 font-display text-4xl font-bold leading-[1.1] tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
                            Sufi Art, Islamic{' '}
                        ...
                        <p className="reveal delay-2 mt-6 max-w-xl text-xl leading-relaxed">
                        ...
                        <p className="reveal delay-2 mt-4 max-w-lg text-sm leading-relaxed text-slate-500">
                        ...
                        <div className="reveal delay-3 mt-4 flex flex-wrap items-center gap-4 text-xs text-slate-500">
                        ...
                        <div className="reveal delay-4 mt-8 flex flex-col gap-3 sm:flex-row">
                            <button
                                onClick={onViewShowcase}
                                className="group flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-violet-700 px-6 py-3.5 text-sm font-semibold text-white transition-all hover:shadow-[0_0_30px_-5px_rgba(124,58,237,0.5)] hover:scale-[1.02] active:scale-[0.98]"
                            >
                                Browse Gallery
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-6 py-3.5 text-sm font-semibold text-slate-700 transition-all hover:border-violet-600/40 hover:text-violet-700 active:scale-[0.98]"
                            >
                        ...
                        <div className="reveal delay-5 mt-10 flex items-center gap-6 text-sm text-slate-400">
