...
import { Palette, LayoutDashboard, Image as ImageIcon, Inbox, Settings, LogOut, Chrome as Home, Menu, X, Star } from 'lucide-react';
import { useAuth } from '@/context/AuthContext';

type TabKey = 'overview' | 'artworks' | 'inquiries' | 'settings' | 'reviews';
