            ...
            <div className="reveal flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    <button
                        ...
                        disabled={isSeeding}
                        className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs sm:text-sm font-medium text-slate-700 shadow-xs hover:bg-slate-50 disabled:opacity-60 transition-all"
                    ...
                    <button
                        onClick={openNew}
                        className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-violet-700 px-4 py-2 text-xs sm:text-sm font-semibold text-white shadow-md shadow-violet-600/20 hover:shadow-lg hover:shadow-violet-600/30 active:scale-[0.98] transition-all"
                    >
                ...
                {timelineEvents.length === 0 ? (
                    <div className="flex flex-col items-center justify-center p-12 text-center">
                        ...
                        <p className="mt-1 text-xs sm:text-sm text-slate-500 max-w-md">
                            The landing page is currently displaying the built-in default steps. You can customize them by clicking <strong>"Seed Defaults"</strong> or adding your own custom milestones.
                        </p>
                        <button
                            onClick={handleSeedDefaults}
                            disabled={isSeeding}
                            className="mt-5 inline-flex items-center gap-2 rounded-xl bg-violet-600 px-4 py-2 text-xs sm:text-sm font-semibold text-white shadow-sm hover:bg-violet-700 transition-colors"
                        >
                            ...
                            >
                                ...
                                <div className="flex items-center gap-1.5 self-end sm:self-center">
                                    <button
                                        ...
                                        className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 hover:bg-slate-100 hover:text-violet-700 transition-colors"
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                        ...
                        <button
                            type="submit"
                            disabled={saving}
                            className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-violet-700 px-5 py-2 text-sm font-semibold text-white shadow-md hover:shadow-lg disabled:opacity-60"
                        >
